...
def main():
    ...
    parser.add_argument('--pair', action='store_true',
           help='use pair model')
    parser.add_argument('--pretrain_ckpt', default='/home2/lzhang/Seq2Seq/model/bert/',
           help='/home2/lzhang/Seq2Seq-1/model/bert/')
    ...
    val_data_loader = get_loader(opt.val, sentence_encoder,
            N=N, K=K, Q=Q, na_rate=opt.na_rate, batch_size=2, test =True)
    ...
    if model_name == 'proto':
        ...
        model = HND(sentence_encoder, N, hidden_size=opt.hidden_size)
